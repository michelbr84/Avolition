...
from src.graphics.vfx import vfx
...
class CharGen(DirectObject):
    def __init__(self, common):
        ...
        self.load()        
    def load(self):  
        self.font = loader.loadFont('assets/fonts/Bitter-Bold.otf')
        self.currentLevel=0
        ...
        self.mp_logo=DirectFrame(frameSize=(-512, 0, 0, 128),
                                    frameColor=(1,1,1, 1),
                                    frameTexture='assets/textures/ui/mp_logo.png',
                                    state=DGG.NORMAL,
                                    parent=pixel2d)       
        ...
        self.title = DirectFrame(frameSize=(-512, 0, 0, 128),
                                    frameColor=(1,1,1, 1),
                                    frameTexture='assets/textures/ui/select.png',
                                    parent=pixel2d)       
        ...
        self.close=DirectFrame(frameSize=(-32, 0, 0, 32),
                                    frameColor=(1, 1, 1, 1),
                                    frameTexture='assets/icons/skills/close.png',
                                    state=DGG.NORMAL,
                                    parent=pixel2d)        
        ...
        self.start=DirectFrame(frameSize=(-256, 0, 0, 32),                                    
                                    frameTexture='assets/icons/skills/level_select.png',  
                                    frameColor=(1, 1, 1, 1),                                    
                                    parent=pixel2d)       
        ...
        self.slider3 = DirectSlider(range=(0,100),
                                    ...
                                    thumb_frameTexture='assets/textures/ui/glass1.png',
        ...
        self.button1A=DirectFrame(frameSize=(-32, 0, 0, 32),
                                    frameColor=(1, 1, 1, 1),
                                    frameTexture='assets/icons/skills/armor.png',
                                    state=DGG.NORMAL,
                                    parent=pixel2d)        
    ...
    def onClick(self):
        ...
        if my_class=="1":
            ...
            self.button1A['frameTexture']='assets/icons/skills/armor.png'
            self.button1B['frameTexture']='assets/icons/skills/heart.png'
            self.button2A['frameTexture']='assets/icons/skills/shield2.png'
            self.button2B['frameTexture']='assets/icons/skills/move.png'
            self.button3A['frameTexture']='assets/icons/skills/power.png'
            self.button3B['frameTexture']='assets/icons/skills/critical.png'
            ...
            self.button1A['frameTexture']='assets/icons/skills/blast.png'
            self.button1B['frameTexture']='assets/icons/skills/damage.png'
            self.button2A['frameTexture']='assets/icons/skills/lightning.png'
            self.button2B['frameTexture']='assets/icons/skills/thunder.png'
            self.button3A['frameTexture']='assets/icons/skills/amp.png'
            self.button3B['frameTexture']='assets/icons/skills/volt.png'
            ...
            self.button1A['frameTexture']='assets/icons/skills/barbs.png'
            self.button1B['frameTexture']='assets/icons/skills/pierce.png'
            self.button2A['frameTexture']='assets/icons/skills/bleed.png'
            self.button2B['frameTexture']='assets/icons/skills/cripple.png'
            self.button3A['frameTexture']='assets/icons/skills/finese.png'
            self.button3B['frameTexture']='assets/icons/skills/bow_damage.png'
            ...
            self.button1A['frameTexture']='assets/icons/skills/hand_o_fate.png'
            self.button1B['frameTexture']='assets/icons/skills/magma_flow.png'
            self.button2A['frameTexture']='assets/icons/skills/heart_o_fire.png'
            self.button2B['frameTexture']='assets/icons/skills/vulcanic.png'
            self.button3A['frameTexture']='assets/icons/skills/warp.png'
            self.button3B['frameTexture']='assets/icons/skills/thorns.png'
